...
- [ ] Cargo metadata, Cargo.toml, and Cargo.lock consistently report zdev 1.1.1.
- [ ] CHANGELOG.md contains an accurate 1.1.1 patch entry and comparison link.
- [ ] The release candidate remains based on v1.1.0/current main and retains the verified improvements-064 behavior.
- [ ] Formatting, Clippy, tests, build, package listing, generated integration equality, and git diff checks pass before committing the candidate.
