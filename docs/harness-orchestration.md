...
| OpenCode | `commands/zdev-implement.md`, `commands/zdev-verify.md`, `commands/zdev-audit.md` under the selected OpenCode scope | `agents/zdev-implementer.md` and `agents/zdev-verifier.md`; commands use the native task tool. The documented directory is plural `commands/`. |
| Pi | `prompts/zdev-implement.md`, `prompts/zdev-verify.md`, `prompts/zdev-audit.md` | `extensions/zdev-subagent.ts` exposes only `implementer` and `verifier`; the installed zdev skill supplies the shared contract. |
| Oh My Pi | `prompts/zdev-implement.md`, `prompts/zdev-verify.md`, `prompts/zdev-audit.md` | `agents/zdev-implementer.md` and `agents/zdev-verifier.md`, invoked through native `task`; `hub` may resume the implementer for rework. |
