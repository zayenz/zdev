---
name: zdev-goal
description: "Continue a zdev area through native Codex goals, one independently verified task and commit at a time. Use only for an explicit $zdev-goal invocation."
---
